...
<!-- JavaScript Bundle with Popper -->
    ...
    <body>
        ...
        <div class="container">
            <h3 class="text-center">Modificar Socio</h3>
            <div class="row"></div>
                <%
                ...
                <div class="mb-3">
                    <input type="text" class="form-control" name="id" id="id" hidden="true" readonly="true" value=<%=resultado.getIdSocio()%>>
                </div>
                ...
                <!--<button type="submit" class="btn btn-success" onClick="validar()">Modificar</button>  -->
                
                <button type="submit" class="btn btn-success">Modificar</button>
                
                
                <button type="button" class="btn btn-outline-primary" onClick="history.go(-1);">Volver</button>
